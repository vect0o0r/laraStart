        ...
        <div class="col-md-12">
            ...
            <div class="card card-widget widget-user">
                ...
                <div class="widget-user-header text-white"
                    ...
                    <h3 class="widget-user-username text-center">{{form.name}}</h3>
                    <h5 class="widget-user-desc text-center">{{form.bio}}</h5>
                </div>
                        ...
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" @change="updateProfilePhoto"
                                               :class="{ 'is-invalid' : form.errors.has('photo') }" name="photo"
                                               id="photo">
                                        <has-error :form="form"
